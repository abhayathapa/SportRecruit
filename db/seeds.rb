...
person.athlete.update_attributes(:dob => "1990-1-11",:gender =>"Male",:country => "Italy", :height =>168,:weight =>50)
...
(1..2).each do |x|
  ...
  person.athlete.update_attributes(:dob => "1984-11-11",:gender =>"Male",:country => "Spain", :height =>190,:weight =>80)
  person.athlete.stat.update_attributes(:matches => 56, :wins =>23, :losses =>12, :goals =>44, :assists =>2, :cleansheets =>0, :position =>"Striker")
end

(1..2).each do |x|
  person =  Person.find_or_create_by_email(:name =>Faker::Name.name, :sport =>"Football", :person_type =>"Athlete", :email =>Faker::Internet.email, :password =>"aaaaaa", :password_confirmation =>"aaaaaa" )
  person.athlete.update_attributes(:dob => "1989-11-11",:gender =>"Male",:country => "Nepal", :height =>120,:weight =>145)
  person.athlete.stat.update_attributes(:matches => 56, :wins =>23, :losses =>12, :goals =>44, :assists =>2, :cleansheets =>0, :position =>"Defence")
end

(1..2).each do |x|
  person =  Person.find_or_create_by_email(:name =>Faker::Name.name, :sport =>"Ice Hockey", :person_type =>"Athlete", :email =>Faker::Internet.email, :password =>"aaaaaa", :password_confirmation =>"aaaaaa" )
  person.athlete.update_attributes(:dob => "1968-11-11",:gender =>"Male",:country => "Australia", :height =>220,:weight =>120)
  person.athlete.stat.update_attributes(:matches => 56, :wins =>23, :losses =>12, :goals =>44, :assists =>2, :cleansheets =>0, :position =>"Goalie")
end
...
person =  Person.find_or_create_by_email(:name =>Faker::Name.name, :sport =>"American Football", :person_type =>"Athlete", :email =>Faker::Internet.email, :password =>"aaaaaa", :password_confirmation =>"aaaaaa" )
      person.athlete.update_attributes(:dob => "1978-11-11",:gender =>"Female",:country => "Spain",:height =>170,:weight =>70)
...
person =  Person.find_or_create_by_email(:name =>Faker::Name.name, :sport =>"American Football", :person_type =>"Recruiter", :email =>Faker::Internet.email, :password =>"aaaaaa", :password_confirmation =>"aaaaaa" )
      person.recruiter.update_attributes(:coach => "Johnny Rocah", :nickname => "Fatalun", :establishment => "1989-10-11", :country => "Spain" )
